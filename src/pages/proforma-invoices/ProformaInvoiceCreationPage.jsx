...
const ProformaInvoiceCreationPage = () => {
  ...
  useEffect(() => {
    const fetchAutoPopulationData = async () => {
      if (!redirectUrl || !redirectUrl.startsWith("/api/v1/proforma-invoices/create-offer/")) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.detail || "Failed to create proforma invoice.";
      toast.error(errorMessage);
...
export default ProformaInvoiceCreationPage;