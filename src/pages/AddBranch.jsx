...
const AddBranch = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Set field errors from API response if available
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full pl-10 pr-10 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 appearance-none ${
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={submitting}
              className={`px-6 py-2 bg-black text-white rounded-lg hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 ${
