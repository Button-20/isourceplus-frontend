...
const AllTransporterEmployees = () => {
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        setLoading(true);
        const response = await authAxios.get('transporters/94c380e0-440f-430e-b0c2-f1f25d6e47e0/all-employees');
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm">
                      Email {employee.email_is_verified ? 'Verified' : 'Not Verified'}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">
                        {employee.last_login ? formatDate(employee.last_login) : 'Never'}
                      </p>
                    </div>
                  </div>
